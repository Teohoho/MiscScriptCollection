...
parser.add_argument("--RestrainedAtomsIn", type=str, help="A file containing the indices of the atoms to be restrained. The restraint sets that make up the restraint profile must be separated by a newline character.")
parser.add_argument("--RestrainedCoMAtomsIn", type=str, help="A file containing the lists of atoms which make up the two groups that will have their Centers of Mass restrained. The two groups of atoms must be separated by a newline character.")
...
##the whole heating run, so we initialize that force

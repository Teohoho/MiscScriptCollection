...
parser.add_argument("--RestrainedAtomsIn", type=str, help="A file containing the indices of the atoms to be restrained. The restraint sets that make up the restraint profile must be separated by newline characters.")
